...
//types
import { IFormPasswordInputProps, State } from "../../utils/types";
    ...
    <Controller
      ...
      render={({
        ...
        <FormControl variant="standard" className={styles.passwordInput}>
          <InputLabel sx={error && { color: "#d32f2f" }} htmlFor="password">
            Пароль
          </InputLabel>
          <Input
            id="password"
          ...
          />
          <FormHelperText sx={error && { color: "#d32f2f" }} id="password-text">
